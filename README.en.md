...
- **Soundset** — 6 built-in synthesized melody timbres with 3 velocity layers each (Piano / Chiptune / Pad / Bass / E-Piano / Music Box) plus a 6-voice synthesized Drum Kit, rendered at startup, cached to disk, zero realtime DSP
